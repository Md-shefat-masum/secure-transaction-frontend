        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Ecommerce Bill pay</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item">Ecommerce</li>
                        <li class="breadcrumb-item active">Ecommerce pay</li>
                    </ol>
                </div>
                <div>
                    <button
                    ...
                    <div class="col-md-6">
                        <div class="card" style="color:white">
                            <div class="card-body signin">
                                <h2 class="heading-success">All pay able amount : <span class="btn btn-primary">12434/-</span></h2>
                                <form class="form-material form-control-line m-t-40" style="color:white">
                                    <div class="form-group has-success">
                                        <label class="form-control-label" for="success">Address To be Shipped:</label>
                                        <textarea type="text" rows="07" placeholder="Address To be Shipped" style="" class="form-control form-control-success form-control-line" value="" autofocus></textarea> 
                                    </div>
                                    <button type="submit" class="btn btn-outline-success">Add to SHIP</button>
                                </form>
                            </div>
                        </div>
                    </div>
