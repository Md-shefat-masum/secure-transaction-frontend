        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Internet Banking Bill Payment</h3>
                </div>
                                    ...
                                    <div class="p-20">
                                        ...
                                        <form class="form-material form-control-line m-t-40" style="">
                                            <div class="form-group has-success">
                                                <label class="form-control-label" for="success">Bill Type :</label>
                                                <select type="text" placeholder="user name" style="" class="form-control form-control-success form-control-line" value="" autofocus> 
                                                    ...
                                                    <option value="">Gas bill</option>
                                                </select>
                                            </div>
                                            <div class="form-group has-success">
                                                <label class="form-control-label" for="success">Bill no :</label>   
                                            ...
                                            <button type="submit" class="btn btn-outline-success">Pay Bill</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
