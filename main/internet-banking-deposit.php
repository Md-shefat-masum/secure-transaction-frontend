                    ...
                    <div class="col-md-6 m-auto">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs customtab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link active"  href="internet-banking-deposit.php" ><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Deposite</span></a> </li>
                            </ul>
                            <!-- Tab panes -->
                                    ...
                                    <div class="p-20">
                                        ...
                                        <form class="form-material form-control-line m-t-40" style="">
                                            <div class="form-group has-success">
                                                <label class="form-control-label" for="success">Curent Balance :</label>   
                                                <input disabled type="text" placeholder=""value='12234$' style="color:orangered" class=" form-control form-control-success form-control-line" value="" autofocus> 
                                            </div>
                                            <div class="form-group has-success">
